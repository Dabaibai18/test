...
enum Length: AsunFloct {
    case onceWidth  = 20  //横线宽度
    case onceHeight = 0 //横线高度
    case spaceWidth = 5 //间隔宽度
}
...
extension CodeView {
    ...
    fileprivate func creatInputLabel() {
        for num in 0 ..< Int(Base.codeNum) {
            ...
            //我后加的
            label.backgroundColor = UIColor.init(displayP3Red: 242 / 255, green: 242 / 255, blue: 242 / 255 , alpha: 1)
